...
import ResizeObserverA from '@parrotjs/react-resize-observer';
...
const Ellipsis = (props: IEllipsisProps) => {
    ...
    },[rows,ellipsis.text,expanded,onEllipsis,canUseCSSEllipsis]);
    ...
    console.log("render Ellipsis")

    return (
        <ResizeObserverA onResize={resizeOnNextFrame} disabled={canUseCSSEllipsis}>
            <div
                style={{
                    ...style
                }}
